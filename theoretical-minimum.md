...
We will introduce the most popular programming languages, as indicated by the TIOBE index, using the implementation of binary search for comparison of the basic control structures. As you will see, all these languages are essentially the same on the conceptual level, the only difference being conventions.
